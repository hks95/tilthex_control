...
function [x_dot, x_next] = tilthex_dynamics(obj, dt,input)

% function [x_dot, x_next] = tilthex_dynamics(x, input, modelParams)
...
obj.state.R = obj.state.R + dot_R*dt; %rotation matrx
...
%====CHANGED BY ANDREW====
x_dot = [linear_vel;angular_vel]; %should be 6x1
x_next = [obj.state.position; obj.state.pitch; obj.state.yaw; obj.state.roll] %should be 6x1
%=========================
